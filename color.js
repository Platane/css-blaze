...
drw.Color.prototype.setSat = drw.Color.prototype.setSaturation;
drw.Color.prototype.getSat = drw.Color.prototype.getSaturation;
drw.Color.create = function( ){
	
	switch( arguments.length ){
		case 0 : 
			return drw.Color.createWithRGB( 0 , 0 , 0 );
		break;
		case 1 : 
			if( typeof( arguments[0] ) )
				if( arguments[0].charAt( 0 ) == "#" )
					return drw.Color.createWithHex( arguments[0] );
		break;
		case 3 : 
			return drw.Color.createWithRGB( arguments[0] , arguments[1] , arguments[2] );
		break;
	}
}
drw.Color.createWithRGB = function( r , g , b ){
	var c = new drw.Color();
	c.init( r , g , b );
	return c;
}
drw.Color.createWithHex = function( s ){
...
drw.Color.createWithTSV = function( t , s , v ){
	var c = new drw.Color();
	if( s >= 1 )
		s = 0.9999;
	if( v >= 1 )
